...
import cn.moriaty.hothouse.service.GetGhouseListService;
 ...
 */
@RestController
public class GetGhouseListController {
    @Autowired
    GetGhouseListService service;

    @GetMapping(value = "getGhouseList")
    public String getGhouseList(HttpServletRequest request) {
        String result = "";
        try {
            List<Hothouse> list = service.getGhouseList();
